    ...
    <div className={`${bubbleClass} mb-4`}>
      <div className={`${bubbleContentClass} relative group`} ref={messageRef}>
        ...
        <div
          ...
          } top-1/2 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity flex-col gap-2`}
        >
          <button
            onClick={() => setShowReactions(!showReactions)}
            className={`p-2 rounded-full ${
              theme === "dark"
                ? "bg-[#222c33] hover:bg-[#222c33]/80"
        ...
        {showReactions && (
          <div
            ...
            className={`absolute -top-8 ${
              isUserMessage ? "-left-2" : "left-36"
            } transform -translate-x-1/2 flex items-center bg-[#222c33]/90 rounded-full px-2 py-1.5 gap-1 shadow-lg z-50`}
          >
            ...
            <button
              className="hover:bg-[#ffffffa] rounded-full p-1"
        ...
        {message.reactions && message.reactions.length > 0 && (
          <div
            ...
            } -bottom-3 flex gap-1 items-center bg-transparent`}
            style={{
